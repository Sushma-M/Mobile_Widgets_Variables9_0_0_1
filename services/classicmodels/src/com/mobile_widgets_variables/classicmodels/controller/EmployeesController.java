...
import com.mobile_widgets_variables.classicmodels.service.EmployeesService;
...
public Employees createEmployees(@RequestBody Employees employees) {
    ...
    @RequestMapping(value="/{id:.+}/customersesForSalesRepEmployeeNumber", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the customersesForSalesRepEmployeeNumber instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Customers> findAssociatedCustomersesForSalesRepEmployeeNumber(@PathVariable("id") Integer id, Pageable pageable) {

        LOGGER.debug("Fetching all associated customersesForSalesRepEmployeeNumber");
        return employeesService.findAssociatedCustomersesForSalesRepEmployeeNumber(id, pageable);
    }

    @RequestMapping(value="/{id:.+}/customersesForSalesRepEmployeeNumberRelation", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the customersesForSalesRepEmployeeNumberRelation instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Customers> findAssociatedCustomersesForSalesRepEmployeeNumberRelation(@PathVariable("id") Integer id, Pageable pageable) {

        LOGGER.debug("Fetching all associated customersesForSalesRepEmployeeNumberRelation");
        return employeesService.findAssociatedCustomersesForSalesRepEmployeeNumberRelation(id, pageable);
    }
