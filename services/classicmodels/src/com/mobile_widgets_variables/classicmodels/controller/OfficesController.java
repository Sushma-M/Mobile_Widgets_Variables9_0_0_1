...
import com.mobile_widgets_variables.classicmodels.service.OfficesService;
...
public Offices createOffices(@RequestBody Offices offices) {
    ...
    @RequestMapping(value="/{id:.+}/employeesesForOfficeCode", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the employeesesForOfficeCode instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Employees> findAssociatedEmployeesesForOfficeCode(@PathVariable("id") String id, Pageable pageable) {

        LOGGER.debug("Fetching all associated employeesesForOfficeCode");
        return officesService.findAssociatedEmployeesesForOfficeCode(id, pageable);
    }

    @RequestMapping(value="/{id:.+}/employeesesForOfficeCodeRelation", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the employeesesForOfficeCodeRelation instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Employees> findAssociatedEmployeesesForOfficeCodeRelation(@PathVariable("id") String id, Pageable pageable) {

        LOGGER.debug("Fetching all associated employeesesForOfficeCodeRelation");
        return officesService.findAssociatedEmployeesesForOfficeCodeRelation(id, pageable);
    }
