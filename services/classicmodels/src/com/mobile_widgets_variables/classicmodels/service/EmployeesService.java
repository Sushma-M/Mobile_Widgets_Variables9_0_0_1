...
public interface EmployeesService {
    ...
    /*
     * Returns the associated customersesForSalesRepEmployeeNumber for given Employees id.
     *
     ...
     * @see Page
     */
    Page<Customers> findAssociatedCustomersesForSalesRepEmployeeNumber(Integer employeeNumber, Pageable pageable);

    /*
     * Returns the associated customersesForSalesRepEmployeeNumberRelation for given Employees id.
     *
     * @param employeeNumber value of employeeNumber; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     * @return Paginated list of associated Customers instances.
     ...
     * @see Page
     */
    Page<Customers> findAssociatedCustomersesForSalesRepEmployeeNumberRelation(Integer employeeNumber, Pageable pageable);
