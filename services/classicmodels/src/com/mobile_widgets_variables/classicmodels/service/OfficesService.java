...
public interface OfficesService {
    ...
    /*
     * Returns the associated employeesesForOfficeCode for given Offices id.
     *
     ...
     * @see Page
     */
    Page<Employees> findAssociatedEmployeesesForOfficeCode(String officeCode, Pageable pageable);

    /*
     * Returns the associated employeesesForOfficeCodeRelation for given Offices id.
     *
     * @param officeCode value of officeCode; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     * @return Paginated list of associated Employees instances.
     ...
     * @see Page
     */
    Page<Employees> findAssociatedEmployeesesForOfficeCodeRelation(String officeCode, Pageable pageable);
