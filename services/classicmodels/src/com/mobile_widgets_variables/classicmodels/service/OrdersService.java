...
public interface OrdersService {
    ...
    /*
     * Returns the associated orderdetailsesForOrderNumber for given Orders id.
     *
     ...
     * @see Page
     */
    Page<Orderdetails> findAssociatedOrderdetailsesForOrderNumber(Integer orderNumber, Pageable pageable);

    /*
     * Returns the associated orderdetailsesForOrderNumberRelation for given Orders id.
     *
     * @param orderNumber value of orderNumber; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     * @return Paginated list of associated Orderdetails instances.
     ...
     * @see Page
     */
    Page<Orderdetails> findAssociatedOrderdetailsesForOrderNumberRelation(Integer orderNumber, Pageable pageable);
